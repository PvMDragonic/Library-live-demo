...
export function BookForm({ header, delMsg, book, setBook, saveBook }: IBookForm)
{
    ...
    const { hasScroll } = useHasScrollbar({ elementRef: mainBodyRef, altCompareRef: bookFormRef });
    ...
    useEffect(() => 
    {
        ...
        {
            setTags(await Tags.showAll() as ITag[]);
        }
        ...
        <>
            ...
            >
                ...
                <form 
                    ...
                    style = {{
                        paddingRight: hasScroll && !delMsg ? '0.65rem' : '1.5rem',
